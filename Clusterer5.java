...
public class Clusterer5
{
	//------------------------------ Parameters -------------------------------------//

	private static final String File_Name_Input = "./Data/maximal_data_1397.txt"; //"test_cluster.txt";//
	private static final String File_Name_Input2 = "./Data/gene_map_1397.txt"; //"test_cluster.txt";//
	private static final String File_Name_Input3 = "./Data/output_members_1397.txt"; //"test_cluster.txt";//
	private static final String File_Name_Input4 = "./Data/abstract_id.txt";
	...
	public static void readGeneMappings() throws IOException
	{
		String str, key;
		int id;

		fr = new FileReader(File_Name_Input2);
		inFile = new BufferedReader(fr);
	...
	public static void readAbstractMappings() throws IOException
	{
		...
		//-------- read abstract id ----------
		fr = new FileReader(File_Name_Input4);
		inFile = new BufferedReader(fr);
